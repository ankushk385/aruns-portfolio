      ...
      <div className="row m-2 justify-content-center my-5 py-5">
        ...
        <div className="col col-lg-6 mt-5 shadow-lg p-3 mb-5 bg-white rounded">
          ...
          <p>
            ...
            add // eslint-disable-next-line to the line before.When using
            display: grid, you can make use of gap utilities on the parent grid
            container. This can save on having to add margin utilities to
            individual grid items (children of a display: grid container). Gap
